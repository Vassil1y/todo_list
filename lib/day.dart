...
import 'package:todo_list/dismissible_description.dart';
...
class Day extends StatefulWidget {
  Day({Key? key, required this.data, required this.notifyParent, required this.dayIndex}) : super(key: key) {
                ...
                duration: const Duration(milliseconds: 250),
                    ...
                    child:ListView.builder(
                        ...
                        itemBuilder: (context, index2){
                          return
                              DismTask(task: widget.orderedData[index2], taskList: widget.orderedData, notifyParent: refer,);
                            // ListPart(
                            // list: widget.data[widget.dayIndex].taskList,
