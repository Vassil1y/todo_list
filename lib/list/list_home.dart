...
import '../data.dart';
import 'package:todo_list/list/list_of_days/day.dart';
                ...
                builder: (context) => AlertDialog(
                      ...
                      content: Column(
                        children: [
                          Row(
                            children: [
                              TextButton(
                                  onPressed: () {}, child: const Text("High")),
                              TextButton(
                                  onPressed: () {},
                                  child: const Text("Medium")),
                              TextButton(
                                  onPressed: () {}, child: const Text("Low"))
                            ],
                          ),
                          Padding(
                      ...
                      actions: [
                        ...
                        TextButton(
                            onPressed: () {
                              setState(() {
                                totalData.list[0].taskList
                                    .add(TaskData(taskTitle, taskText, "Low"));
                              });
                              Navigator.of(context).pop();
                            },
